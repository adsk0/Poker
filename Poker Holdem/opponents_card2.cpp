...
int func_opponents_card2()
{
    ...
    opponents_card2 = rand() % 52;
    while (opponents_card2 == card1 || opponents_card2 == card2 || opponents_card2 == opponents_card1)
    {
        opponents_card2 = rand() % 52;
    }
    return opponents_card2;
}

...
int func_turn_card()
{
    ...
    turn_card = rand() % 52;
    while (turn_card == card1 || turn_card == card2 || turn_card == opponents_card1 || turn_card == opponents_card2 || turn_card == flops_card1 || turn_card == flops_card2 || turn_card == flops_card3)
    {
        turn_card = rand() % 52;
    }
    return turn_card;
